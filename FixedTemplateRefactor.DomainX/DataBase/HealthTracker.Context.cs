...
namespace FixedTemplateRefactor.DomainX.DataBase
{
    ...
    public partial class HealthTrackerEntities : DbContext
    {
        ...
        public virtual ObjectResult<GetPersonSummary2_Result> GetPersonSummary2(Nullable<int> personId)
        {
            var personIdParameter = personId.HasValue ?
                new ObjectParameter("personId", personId) :
                new ObjectParameter("personId", typeof(int));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<GetPersonSummary2_Result>("GetPersonSummary2", personIdParameter);
        }
